  ...
  return (
    <div className="mb-4">
      ...
      <div className="relative">
        ...
        <input
          className="peer block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 pl-10 text-sm text-gray-900 outline-none focus:ring-2 focus:ring-sky-200"
          type="text"
          id="filter"
